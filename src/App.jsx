      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 relative z-10 flex flex-col gap-40">
        ...
        <nav className="flex justify-between items-center w-full py-6 backdrop-blur-md sticky top-0 z-50 rounded-b-3xl border-b border-white/5 bg-[#050505]/60 mb-8 px-6">
          ...
          <div className="flex gap-8 font-medium text-lg">
            ...
            <a href="/Ayush_Kashyap_CV.pdf" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-sky-400 transition-all hover:scale-110 border-l border-white/20 pl-8">CV</a>
          </div>
        </nav>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-16 relative z-10">
            <a 
              ...
              className="group relative px-12 py-5 bg-white text-slate-950 rounded-full font-black text-xl tracking-widest uppercase overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] text-center"
            >
            ...
            <button 
              ...
              className="px-12 py-5 rounded-full bg-slate-900/50 border border-white/10 text-white font-black text-xl tracking-widest uppercase backdrop-blur-xl hover:bg-white/10 transition-all duration-300 hover:scale-105 text-center flex items-center justify-center gap-3 group"
            >
              Learn More
        ...
        >
          <div className="bg-slate-950/80 backdrop-blur-3xl p-16 md:p-32 rounded-[5rem] w-full h-full relative overflow-hidden flex flex-col items-center">
            ...
            <div className="flex flex-col items-center gap-12 relative z-10 w-full max-w-5xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row gap-6 mt-12 w-full md:w-auto justify-center">
                <a 
                  href="/Ayush_Kashyap_CV.pdf" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-white text-slate-950 hover:bg-sky-50 hover:text-sky-600 px-16 py-8 rounded-full font-black tracking-widest uppercase text-2xl shadow-[0_0_60px_rgba(255,255,255,0.2)] transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-[0_0_80px_rgba(255,255,255,0.4)] text-center grow md:grow-0"
                >
                   View CV
                </a>
                <a 
                  ...
                  className="bg-slate-900 text-white hover:bg-slate-800 px-16 py-8 rounded-full font-black tracking-widest uppercase text-2xl border border-white/10 transition-all duration-300 hover:scale-105 hover:-translate-y-2 text-center grow md:grow-0 backdrop-blur-xl"
                >
                   Download
                </a>
              </div>
